...
#           ecCodes library                              #
##########################################################
ifneq "$(SFX_GRIBAPI)" "yes"

ifeq "$(VER_ECCODES)" "ECCODES_AUTO"
DIR_ECCODES_SRC?=${SRC_SURFEX}/src/LIB/eccodes-${VERSION_ECCODES}-Source
DIR_ECCODES_BUILD?=${SRC_SURFEX}/src/LIB/eccodes-${VERSION_ECCODES}-${ARCH}-build
DIR_ECCODES_INSTALL?=${DIR_ECCODES_SRC}-${ARCH}
ECCODES_MOD?=${DIR_ECCODES_INSTALL}/include/grib_api.mod
#
INC_ECCODES   ?= -I${DIR_ECCODES_INSTALL}/include
LIB_ECCODES   ?= -L${DIR_ECCODES_INSTALL}/lib -L${DIR_ECCODES_INSTALL}/lib64 -leccodes_f90 -leccodes -Wl,-rpath,${DIR_ECCODES_INSTALL}/lib
endif

ifeq "$(VER_ECCODES)" "BULL2020"
DIR_ECCODES_INSTALL=/opt/softs/libraries/ICC_2018.5.274/eccodes-2.15.0
INC_ECCODES   ?= -I${DIR_ECCODES_INSTALL}/include
LIB_ECCODES   ?= -L${DIR_ECCODES_INSTALL}/lib -L${DIR_ECCODES_INSTALL}/lib64 -leccodes_f90 -leccodes -Wl,-rpath,${DIR_ECCODES_INSTALL}/lib
endif

ifneq "x$(VER_ECCODES)" "x"
INC           += $(INC_ECCODES)
LIBS          += $(LIB_ECCODES)
...
DIR_CDF?=${SRC_SURFEX}/src/LIB/netcdf4/netcdf-c-${VERSION_CDF}
...
CDF_PATH?=/usr
INC_NETCDF     = -I${CDF_PATH}/include
LIB_NETCDF     = -L${CDF_PATH}/lib64 -L/usr/lib/x86_64-linux-gnu/hdf5/serial/ -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lsz -lz
